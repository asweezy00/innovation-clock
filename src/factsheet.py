...
<section class="pagebreak">
  ...
  <div class="foot">Appendix · The Innovation Clock · Abdullah Shahid · self-contained work sample built from public FDA &amp; CMS data</div>
</section>
"""
...
.byline {{ font-family:'Helvetica Neue',Arial,sans-serif; font-size:9.3px; color:#555; margin:1px 0 9px; }}
.byline b {{ color:#1d1d1f; }}
.cta {{ display:flex; align-items:center; justify-content:space-between; gap:14px; background:#1b6ca8;
        border-radius:8px; padding:11px 16px; margin:2px 0 12px; }}
.cta .cta-t {{ font-family:'Helvetica Neue',Arial,sans-serif; color:#fff; }}
.cta .cta-t b {{ font-size:12px; display:block; }}
.cta .cta-t span {{ font-size:9.3px; opacity:.92; }}
.cta a {{ background:#fff; color:#1b6ca8; text-decoration:none; font-weight:700;
          font-family:'Helvetica Neue',Arial,sans-serif; font-size:10.5px; padding:8px 15px;
...
<p class="byline">Created by <b>Abdullah Shahid</b> — Biomedical Engineering &amp; Economics/Statistics, UNC–Chapel Hill &amp; NC&nbsp;State (May&nbsp;2026)</p>
<div class="cta">
  <div class="cta-t"><b>Explore the interactive version →</b>
  <span>Click any drug for its approval-to-indication timeline, Medicare spend, and negotiation clock — or compare the full cohort.</span></div>
...
<div class="foot">The Innovation Clock · Abdullah Shahid · built from public FDA &amp; CMS data · {DASHBOARD_URL}</div>
</body></html>"""
